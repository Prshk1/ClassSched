...
const Reports = () => {
  ...
  // Sample data for different report types (keep these small; replace with real data from API/store)
  const classScheduleData = {
    "Monday-7:45 AM": { subject: "Homeroom", teacher: "Dr. Smith", room: "Room 201" },
    "Monday-8:30 AM": { subject: "Mathematics", teacher: "Dr. Smith", room: "Room 201" },
    "Tuesday-9:15 AM": { subject: "English", teacher: "Ms. Johnson", room: "Room 103" },
    "Wednesday-10:00 AM": { subject: "Science", teacher: "Mr. Brown", room: "Lab 1" },
  };

  // ref to the report area we want to print/export
  ...
  const handlePrint = () => {
    ...
    doc.open();
    doc.write(`<!doctype html><html><head><meta charset="utf-8"><title>Report</title>${styles}</head><body>${printableRef.current.innerHTML}</body></html>`);
    doc.close();
      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            ...
            <p className="text-muted-foreground">Generate and export schedules</p>
          </div>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Select the type of schedule report to generate</CardDescription>
          </CardHeader>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              <div className="space-y-2">
                <label className="text-sm font-medium">
                  ...
                  {reportType === "teacher" && "Select Teacher"}
                  {reportType === "room" && "Select Room"}
                </label>
                  ...
                  <SelectContent>
                    ...
                    {reportType === "teacher" && (
                      <>
                        ...
                        <SelectItem value="ms-johnson">Ms. Emily Johnson</SelectItem>
                        <SelectItem value="mr-brown">Mr. Michael Brown</SelectItem>
                      </>
                    )}
                    {reportType === "room" && (
                      <>
        ...
        {selectedFilter && (
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                {reportType === "class" && "Class Schedule: Grade 11 - STEM 1"}
                {reportType === "teacher" && "Teacher Schedule: Dr. Sarah Smith"}
                {reportType === "room" && "Room Schedule: Room 201"}
              </CardDescription>
            </CardHeader>
            <CardContent>
